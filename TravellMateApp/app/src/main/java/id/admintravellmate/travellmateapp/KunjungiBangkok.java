...
public class KunjungiBangkok extends AppCompatActivity {
    ...
    public void setImageView1() {
        Intent intent = new Intent(KunjungiBangkok.this, PaketTour.class);
    ...
    public void setButtonKunjungi1() {
        Intent intent = new Intent(KunjungiBangkok.this, FormKunjungiBangkok.class);
        startActivity(intent);
        finish();
    }
}